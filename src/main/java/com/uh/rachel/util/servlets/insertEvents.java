    ...
    public class insertEvents extends HttpServlet{
        protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            DataHandler.insertEventsRowByID(
                    ...
                    (request.getParameter("eventNameInput")),
                    (request.getParameter("eventTypeInput")),
                    (request.getParameter("eventCityInput")),
                    (request.getParameter("eventStateInput")),
                    (request.getParameter("eventDateInput")),
